...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatNYC3URI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + NYC3Units::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatNYC3URI(info));
}
