// Copyright (c) 2011-2019 The NYC3 Core developers
...
NYC3GUI::NYC3GUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
...
#ifdef ENABLE_WALLET
    if(enableWallet) {
        connect(walletFrame, &WalletFrame::requestedSyncWarningInfo, this, &NYC3GUI::showModalOverlay);
        connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &NYC3GUI::showModalOverlay);
        connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &NYC3GUI::showModalOverlay);
    }
#endif
...
void NYC3GUI::createActions()
{
    ...
    connect(overviewAction, &QAction::triggered, this, &NYC3GUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(sendCoinsMenuAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsMenuAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &NYC3GUI::gotoReceiveCoinsPage);
    connect(receiveCoinsMenuAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsMenuAction, &QAction::triggered, this, &NYC3GUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &NYC3GUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    connect(aboutAction, &QAction::triggered, this, &NYC3GUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &NYC3GUI::optionsClicked);
    connect(toggleHideAction, &QAction::triggered, this, &NYC3GUI::toggleHidden);
    connect(showHelpMessageAction, &QAction::triggered, this, &NYC3GUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &NYC3GUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &NYC3GUI::openClicked);
        connect(m_open_wallet_action->menu(), &QMenu::aboutToShow, [this] {
            ...
            for (std::string path : m_wallet_controller->getWalletsAvailableToOpen()) {
                ...
                connect(action, &QAction::triggered, [this, name, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &NYC3GUI::setCurrentWallet);
    ...
    connect(new QShortcut(QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_C), this), &QShortcut::activated, this, &NYC3GUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_D), this), &QShortcut::activated, this, &NYC3GUI::showDebugWindow);
}
...
void NYC3GUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &NYC3GUI::setCurrentWalletBySelectorIndex);
...
void NYC3GUI::setClientModel(ClientModel *_clientModel)
{
    ...
    if(_clientModel)
    {
        ...
        updateNetworkState();
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &NYC3GUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &NYC3GUI::setNetworkActive);

        modalOverlay->setKnownBestHeight(_clientModel->getHeaderTipHeight(), QDateTime::fromTime_t(_clientModel->getHeaderTipTime()));
        setNumBlocks(m_node.getNumBlocks(), QDateTime::fromTime_t(m_node.getLastBlockTime()), m_node.getVerificationProgress(), false);
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &NYC3GUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &NYC3GUI::showProgress);
        ...
        if (optionsModel && trayIcon) {
            ...
            connect(optionsModel, &OptionsModel::hideTrayIconChanged, this, &NYC3GUI::setTrayIconVisible);
...
#ifdef ENABLE_WALLET
void NYC3GUI::setWalletController(WalletController* wallet_controller)
{
    ...
    connect(wallet_controller, &WalletController::walletAdded, this, &NYC3GUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &NYC3GUI::removeWallet);
...
void NYC3GUI::addWallet(WalletModel* walletModel)
{
...
void NYC3GUI::removeWallet(WalletModel* walletModel)
{
    if (!walletFrame) return;
...
void NYC3GUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame) return;
...
void NYC3GUI::setCurrentWalletBySelectorIndex(int index)
{
...
void NYC3GUI::createTrayIconMenu()
{
    ...
    connect(trayIcon, &QSystemTrayIcon::activated, this, &NYC3GUI::trayIconActivated);
#else
    // Note: On macOS, the Dock icon is used to provide the tray's functionality.
    MacDockIconHandler *dockIconHandler = MacDockIconHandler::instance();
    connect(dockIconHandler, &MacDockIconHandler::dockIconClicked, this, &NYC3GUI::macosDockIconActivated);
...
#else
void NYC3GUI::macosDockIconActivated()
{
    show();
    activateWindow();
}
...
void NYC3GUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
...
void NYC3GUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &NYC3GUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &NYC3GUI::show);
                e->ignore();
            }
        }
    }
...
#ifdef ENABLE_WALLET
void NYC3GUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
...
void NYC3GUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void NYC3GUI::updateWalletStatus()
{
    if (!walletFrame) {
        return;
    }
...
void NYC3GUI::updateWindowTitle()
{
    ...
    menu(nullptr)
{
    ...
    {
        max_width = qMax(max_width, fm.width(NYC3Units::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const NYC3Units::Unit u : NYC3Units::availableUnits())
    {
        QAction *menuAction = new QAction(QString(NYC3Units::longName(u)), this);
...
{
    setText(NYC3Units::longName(newUnits));
}
