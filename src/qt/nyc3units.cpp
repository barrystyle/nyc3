...
QString NYC3Units::longName(int unit)
{
    switch(unit)
    {
    case NYC3: return QString("NYC3");
    case mNYC3: return QString("mNYC3");
    case uNYC3: return QString::fromUtf8("µNYC3 (bits)");
    case SAT: return QString("Satoshi (sat)");
    default: return QString("???");
    }
}

QString NYC3Units::shortName(int unit)
{
    switch(unit)
    {
    case uNYC3: return QString::fromUtf8("bits");
...
QString NYC3Units::description(int unit)
{
    ...
    case uNYC3: return QString("Micro-NYC3s (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
...
QString NYC3Units::getAmountColumnTitle(int unit)
{
    ...
    {
        amountTitle += " ("+NYC3Units::shortName(unit) + ")";
    }
    return amountTitle;
}
