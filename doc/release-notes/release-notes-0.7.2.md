NYC3 version 0.7.2 is now available from:
  http://sourceforge.net/projects/bitcoin/files/NYC3/bitcoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused NYC3-Qt to crash on Windows when exiting.
