NYC3 version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/NYC3/bitcoin-0.5.4/
...
Fix NYC3-Qt notifications under Growl 1.3.
Increase required age of NYC3-Qt's "not up to date" status from 30 to 90 minutes.
