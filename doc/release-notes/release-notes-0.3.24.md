NYC3 v0.3.24 is now available for download at
https://sourceforge.net/projects/bitcoin/files/NYC3/bitcoin-0.3.24/
...
C3) Initial unit testing framework.  NYC3 sorely needs automated tests, and this is a beginning.  Contributions welcome.
