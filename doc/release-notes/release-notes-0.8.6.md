NYC3-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/bitcoin/files/NYC3/bitcoin-0.8.6/
...
- Fix NYC3-Qt startup crash when clicking dock icon on OSX 
