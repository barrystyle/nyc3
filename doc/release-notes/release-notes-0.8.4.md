NYC3-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/NYC3/bitcoin-0.8.4/
...
code, causing the NYC3-Qt or bitcoind process to crash.
...
their own version of NYC3 against Boost versions 1.50-1.52.
